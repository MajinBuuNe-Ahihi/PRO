...
class DuckDuckGoTools(Toolkit):
    ...
    def duckduckgo_search(self, query: str, max_results: int = 5) -> str:
        ...
        return json.dumps(ddgs.text(query=search_query, max_results=actual_max_results, region=self.region), indent=2)
    ...
    def duckduckgo_news(self, query: str, max_results: int = 5) -> str:
        ...
        return json.dumps(
            ddgs.news(query=query, max_results=actual_max_results, region=self.region),
            indent=2,
        )
